...
class Search():
    ...
    def draw_map(self, last_known):
        """Display base map with scale, last known xy location, search areas."""
    ...
    def sailor_final_location(self, num_search_areas):
        """Return the actual xy coords of the missing sailor"""
        # Find sailor coords with respect to any SA subarray
    ...
    def conduct_search(self, area_num, area_array, effectiveness_prob):
        """Return search results and list of searched coords"""
    ...
    def revise_target_probs(self):
        """Update area target probs based on SA"""
...
def main():
    ...
    while True:
        ...
        if choice.isdigit():
            ...
            print('\nPlease enter a number.', file=sys.stderr)
            continue
